...
from util.datasets import load_garmentcodedata
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='ae_garments', type=str, metavar='MODEL',
                        help='Name of model to train')

    parser.add_argument('--point_cloud_size', default=4096, type=int,
                        help='input size')
...
def main(args):
    ...
    dataset_train = load_garmentcodedata('training', args=args)
    dataset_val = load_garmentcodedata('validation', args=args)
