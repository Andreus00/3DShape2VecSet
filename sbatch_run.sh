...
#SBATCH --mail-user=andrea.sanchietti@unituebingen.de   # Email to which notifications will be sent
...
# Compute Phase
srun env -u SLURM_PROCID python3 main_ae_garmentcode.py --data_path ../GarmentCode/garmentcodedata_v2 # srun will automatically pickup the configuration defined via `#SBATCH` and `sbatch` command line arguments  
