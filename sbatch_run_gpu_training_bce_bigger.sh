...
#SBATCH --gres=gpu:4
#SBATCH --output=./logs_ge_bce_bigger/myjob-%j.out       # File to which STDOUT will be written - make sure this is not on $HOME
#SBATCH --error=./logs_ge_bce_bigger/myjob-%j.err        # File to which STDERR will be written - make sure this is not on $HOME
