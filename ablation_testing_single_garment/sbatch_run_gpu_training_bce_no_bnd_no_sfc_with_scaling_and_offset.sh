...
#SBATCH --error=./logs_ge_bce_no_bnd_no_sfc_scale_offset/myjob-%j.err        # File to which STDERR will be written - make sure this is not on $HOME
...
srun env -u SLURM_PROCID python3 -m torch.distributed.launch \
    ...
    --save_every 1 \
    --epochs 800 \
    --output_dir output_bce_no_bnd_no_sfc_scaling_offset \
    --log_dir output_bce_no_bnd_no_sfc_scaling_offset \
