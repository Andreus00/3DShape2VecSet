...
srun env -u SLURM_PROCID python3 -m torch.distributed.launch --rdzv_endpoint=localhost:29399 main_ae_garmentcode.py --data_path ../GarmentCode/garmentcodedata_v2 --device cuda --batch_size 2 --accum_iter 4 --max_dist 0.1 --warmup_epoch 0 --lr 0.00001 --save_every 1 --epochs 800 --output_dir output_bce --log_dir output_bce --force_occupancy
